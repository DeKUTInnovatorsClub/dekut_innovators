...
const WhyJoinUs = () => {
  return (
    <div className="bg-white py-12 px-6">
      <h2 className="text-3xl font-bold text-center text-blue-600 mb-8">Why Join Us?</h2>
      <h3 className="text-3xl font-bold text-center text-black mb-8">Discover, Learn, Innovate</h3>
