    ...
    return (
        <div className="become-member-container">
           <div id="become-a-member" className="become-member">
                ...
                <p>Subscription fee of Ksh. 100 per semester</p>
            </div>
            <a href="https://docs.google.com/forms/d/e/1FAIpQLSfjPTJdWIZxH-Z1xffmUZpAnmU9-DUestbpB1bd_GA0xPLM0w/viewform?usp=header" target="_blank">Join the club</a> 
        </div>
